      ...
      <v-row justify="center">
        <v-col cols="10">
          <v-text-field
            ...
            placeholder="第一次管理员登录，请输入邀请码"
            label="邀请码不是必须的，在管理员验证的时候需要使用"
            clearable
    ...
    getVerifyImage() {
      this.$axios({
                 ...
                 method:'get'
                  ...
                  this.verifyImageUrl =re.data.img;
                  this.registerUser.token = re.data.captchaToken;
                })
