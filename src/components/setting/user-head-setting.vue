    ...
    <v-row justify="center" align="center">
      <v-col>
        ...
        >
          ...
          <v-row >
            <!-- <UploadImage @image="uploadImageSuccess"></UploadImage> -->
<el-upload
  class="upload-demo"
  ...
  <script>
  import UploadImage from '@/components/upload/file-upload-image.vue'
  ...
  export default {
    ...
    methods: {
      ...
      uploadSuccess(re, file, fileList){
        ...
        if(re.status == 200){
                        this.userInfo.avatarUrl = re.data.fileUrl;
